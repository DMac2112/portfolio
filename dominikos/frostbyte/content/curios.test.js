...
describe('Curio content registry', () => {
  it('ships the W1-W6 room discoveries as valid unique contracts', () => {
    ...
    expect(CURIO_REGISTRY.filter((curio) => curio.roomId === 'caverns')).toHaveLength(6);
    expect(CURIO_REGISTRY).toHaveLength(39);
