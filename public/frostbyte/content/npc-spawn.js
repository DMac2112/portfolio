...
export const ROOM_SPAWN = {
  ...
  trail: {
    ...
    roamPoints: [
      { x: 300, y: 500 }, { x: 450, y: 420 }, { x: 600, y: 500 },
      { x: 800, y: 650 }, { x: 1000, y: 450 }, { x: 1150, y: 650 },
    ],
    gatherPoints: [
      { x: 720, y: 390, label: 'falls-frostline' },
      { x: 1040, y: 470, label: 'signpost-trail' },
    ],
  ...
  court: {
    capacity: { min: 4, max: 6 },
    roamPoints: [
      { x: 210, y: 525 }, { x: 480, y: 450 }, { x: 660, y: 390 },
      { x: 900, y: 510 }, { x: 570, y: 700 }, { x: 930, y: 650 },
      { x: 600, y: 620 }, { x: 1000, y: 650 },
    ],
    gatherPoints: [
      { x: 900, y: 690, label: 'lantern-ladle-patio' },
      { x: 570, y: 700, label: 'snowtail-playpen' },
